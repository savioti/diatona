...
const _cC = [ // x 3 2 0 1 0
  (1, 3, true),  // A string fret 3 = root
  (2, 2, false), // D string fret 2
  (3, 0, false), // G open
  (4, 1, false), // B fret 1
  (5, 0, false), // e open
];
const _cA = [ // x 0 2 2 2 0
  (1, 0, true),  // A open = root
  (2, 2, false),
  (3, 2, false),
  (4, 2, false),
  (5, 0, false),
];
const _cG = [ // 3 2 0 0 0 3
  (0, 3, true),  // low E fret 3 = root
  (1, 2, false),
  (2, 0, false),
  (3, 0, false),
  (4, 0, false),
  (5, 3, true),  // high e fret 3 = root octave
];
const _cE = [ // 0 2 2 1 0 0
  (0, 0, true),  // low E open = root
  (1, 2, false),
  (2, 2, false),
  (3, 1, false),
  (4, 0, false),
  (5, 0, true),  // high e open = root
];
const _cD = [ // x x 0 2 3 2
  (2, 0, true),  // D open = root
  (3, 2, false),
  (4, 3, false),
  (5, 2, false),
];
...
class _CagedSystemWidgetState extends State<CagedSystemWidget>
  ...
  List<(int, int, bool)> get _currentDots => _shapes[_shapeIndex];
